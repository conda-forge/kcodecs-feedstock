...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/kcodecs-feedstock/blob/main/LICENSE.txt)
...
<table>
  ...
  <tr>
    ...
    <td>
      <details>
        <summary>
          <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=8471&branchName=main">
            <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/kcodecs-feedstock?branchName=main">
          </a>
        </summary>
        <table>
          ...
          <tbody><tr>
              ...
              <td>
                <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=8471&branchName=main">
                  <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/kcodecs-feedstock?branchName=main&jobName=linux&configuration=linux_64_" alt="variant">
                </a>
              </td>
            </tr>
          </tbody>
...
Once the `conda-forge` channel has been enabled, `kcodecs` can be installed with `conda`:
...
```
mamba install kcodecs
```

It is possible to list all of the versions of `kcodecs` available on your platform with `conda`:
...
```
mamba search kcodecs --channel conda-forge
```
...
mamba repoquery search kcodecs --channel conda-forge

# List packages depending on `kcodecs`:
mamba repoquery whoneeds kcodecs --channel conda-forge

# List dependencies of `kcodecs`:
mamba repoquery depends kcodecs --channel conda-forge
```
